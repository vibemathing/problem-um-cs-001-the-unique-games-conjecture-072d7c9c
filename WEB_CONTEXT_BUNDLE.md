...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-cs-001-the-unique-games-conjecture-072d7c9c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/CS-001"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-cs-001-the-unique-games-conjecture-072d7c9c-v1",
      "problem_contract_sha256": "f5a22c92826f8bd41d88b332c00bc77b65be29336ef3c82cadab66adf08ddbf6",
      "problem_id": "problem:um-cs-001-the-unique-games-conjecture-072d7c9c",
      "route_id": "route:um-cs-001-the-unique-games-conjecture-072d7c9c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-cs-001-the-unique-games-conjecture-072d7c9c-source-fidelity-01",
      "graph_id": "graph:um-cs-001-the-unique-games-conjecture-072d7c9c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-cs-001-the-unique-games-conjecture-072d7c9c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-cs-001-the-unique-games-conjecture-072d7c9c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For certain constraint satisfaction problems (unique games), it is NP-hard to approximate the maximum fraction of satisfiable constraints beyond a certain threshold."
          },
          "statement_sha256": "17ee876132a74db201762ece3e245db1681d0e365a5e883b81ab76a7bd0d532d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-cs-001-the-unique-games-conjecture-072d7c9c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-cs-001-the-unique-games-conjecture-072d7c9c-root",
      "route_id": "route:um-cs-001-the-unique-games-conjecture-072d7c9c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-cs-001-b114aabf6d3d",
        "url": "https://www.unsolvedmath.com/problems/CS-001"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
